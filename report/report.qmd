...
**Overall Project Takeaway**: After considering the generalization performance of all the models implemented, our boosting Random Model performed the best using the via TPR and accuracy.
